...
每完成或複習一題，只需在自己的 `progress/<GitHub ID>.md` 新增或更新題目。
...
熟悉度是當下狀態，可以在複習後調高，也可以誠實調低。個人心得與複習計畫請放在個人頁面；需要與其他成員交流的內容，則放在該題 README 的「討論與補充」。

## 題目討論規則

每題 README 的「討論與補充」可用於：
...
新增討論時使用 `### @GitHub-ID — YYYY-MM-DD` 作為標題，並保留其他成員的內容。純個人進度不要放在此處，以免和個人頁面重複。
